...
@Database(entities =[User::class,FoodItem::class, OrderDetails::class, FoodItemInOrder::class], version = 1, exportSchema = false)
        ...
        fun getInstance( context: Context): CartDatabase? {
            if (instance == null) {
                synchronized(CartDatabase::class.java) {
                    instance = Room.databaseBuilder(context.applicationContext, CartDatabase::class.java, "zoewrffdmat")
                        .build()
                }
            }
            return instance
